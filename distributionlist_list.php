...
/**
 *   	\file       distributionlist_list.php
 *		\ingroup    distributionlist
 *		\brief      List page for distributionlist
 */
...
require_once __DIR__.'/class/distributionlist.class.php';
...
$contextpage = GETPOST('contextpage', 'aZ') ? GETPOST('contextpage', 'aZ') : 'distributionlistlist'; // To manage different context of search
...
$hookmanager->initHooks(array('distributionlistlist')); // Note that conf->hooks_modules contains array
...
if ($num == 1 && !empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all && !$page)
{
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/distributionlist/distributionlist_card.php', 1).'?id='.$id);
	exit;
}
...
$newcardbutton = dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/distributionlist/distributionlist_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendDistributionListRef";
$modelmail = "distributionlist";
$objecttmp = new DistributionList($db);
