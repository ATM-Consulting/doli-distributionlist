...
ALTER TABLE llx_distributionlist_distributionlistsocpeople ADD INDEX idx_distributionlist_distributionlistsocpeople_ref (ref);
ALTER TABLE llx_distributionlist_distributionlistsocpeople ADD INDEX idx_distributionlist_distributionlistsocpeople_fk_soc (fk_soc);
ALTER TABLE llx_distributionlist_distributionlistsocpeople ADD INDEX idx_distributionlist_distributionlistsocpeople_fk_project (fk_project);
...
ALTER TABLE llx_distributionlist_distributionlistsocpeople ADD INDEX idx_distributionlist_distributionlistsocpeople_status (status);
