...
class mailing_distributionlist extends MailingTargets
{
	...
	public function add_to_target($mailing_id)
	{
		...
		if (!empty($_POST['filter_distributionlist']))
		{
			...
			$sql .= " CONCAT('<a href=\"http://192.168.0.37/client/srv53/sgp/dolibarr/htdocs/contact/card.php?id=',sp.rowid,'\"><span class=\"fas fa-address-book paddingright classfortooltip\" style=\" color: #37a;\"></span>',sp.firstname, sp.lastname,'</a>') as source_url,";
