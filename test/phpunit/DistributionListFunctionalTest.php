...
/**
 * \file    test/phpunit/DistributionListFunctionalTest.php
...
/**
 * Class DistributionListFunctionalTest
 *
 ...
 *
 * @package Testdistributionlist
 */
class DistributionListFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modDistributionList')->click();
		} else {
			// Disable the module
			$this->byHref('modDistributionList')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/distributionlist/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('distributionlist/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/distributionlist/admin/about.php');
		$this->authenticate();
		return $this->assertContains('distributionlist/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('distributionlistwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDistributionList_DistributionListTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDistributionList_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
