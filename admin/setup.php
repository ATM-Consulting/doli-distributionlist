...
/**
 * \file    distributionlist/admin/setup.php
 * \ingroup distributionlist
 * \brief   DistributionList setup page.
 */
...
require_once '../lib/distributionlist.lib.php';
//require_once "../class/myclass.class.php";

// Translations
$langs->loadLangs(array("admin", "distributionlist@distributionlist"));
...
{
	$maskconstorder = GETPOST('maskConstDistributionList', 'alpha');
	$maskorder = GETPOST('maskDistributionList', 'alpha');
...
} elseif ($action == 'specimen')
{
	...
	{
		$file = dol_buildpath($reldir."core/modules/distributionlist/doc/pdf_".$modele."_".strtolower($tmpobjectkey).".modules.php", 0);
		if (file_exists($file))
		{
			$filefound = 1;
...
} elseif ($action == 'setmod')
{
	...
	$tmpobjectkey = GETPOST('object');
	$constforval = 'DISTRIBUTIONLIST_'.strtoupper($tmpobjectkey)."_ADDON";
...
$page_name = "DistributionListSetup";
llxHeader('', $langs->trans($page_name));

// Subheader
$linkback = '<a href="'.($backtopage ? $backtopage : DOL_URL_ROOT.'/admin/modules.php?restore_lastsearch_values=1').'">'.$langs->trans("BackToModuleList").'</a>';

print load_fiche_titre($langs->trans($page_name), $linkback, 'object_distributionlist@distributionlist');

// Configuration header
$head = distributionlistAdminPrepareHead();
					...
					while (($file = readdir($handle)) !== false)
					{
						if (strpos($file, 'mod_'.strtolower($myTmpObjectKey).'_') === 0 && substr($file, dol_strlen($file) - 3, 3) == 'php')
						{
							...
							if ($module->isEnabled())
							{
								...
								$constforvar = 'DISTRIBUTIONLIST_'.strtoupper($myTmpObjectKey).'_ADDON';
