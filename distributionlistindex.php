...
/**
 *	\file       distributionlist/distributionlistindex.php
 *	\ingroup    distributionlist
 *	\brief      Home page of distributionlist top menu
 */
...
$langs->loadLangs(array("distributionlist@distributionlist"));

$action = GETPOST('action', 'alpha');


// Security check
//if (! $user->rights->distributionlist->myobject->read) accessforbidden();
...
llxHeader("", $langs->trans("DistributionListArea"));

print load_fiche_titre($langs->trans("DistributionListArea"), '', 'distributionlist.png@distributionlist');
...
// Draft MyObject
if (! empty($conf->distributionlist->enabled) && $user->rights->distributionlist->read)
{
	$langs->load("orders");
